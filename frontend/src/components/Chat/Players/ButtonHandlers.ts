...
export function handleFollow(enqueueSnackbar: any, user: User) {
	axios.put("http://" + "f1r3s17" + ":3000/social/" + user.id + "/follow", {}, {withCredentials: true})
	.catch((err) => {
...
export function handleUnfollow(enqueueSnackbar: any, user: User) {
	axios.delete("http://" + "f1r3s17" + ":3000/social/" + user.id + "/unfollow", {withCredentials: true})
	.catch((err) => {
		if (err.response.data.statusCode === 401)
			return ;
		else
...
export function handleBlock(enqueueSnackbar: any, user: User) {
	axios.put("http://" + "f1r3s17" + ":3000/social/" + user.id + "/block", {}, {withCredentials: true})
	.then((payload) => {
	})
	.catch((err) => {
		if (err.response.data.statusCode === 401)
...
export function handleUnblock(enqueueSnackbar: any, user: User) {
	axios.delete("http://" + "f1r3s17" + ":3000/social/" + user.id + "/unblock", {withCredentials: true})
	.catch((err) => {
		if (err.response.data.statusCode === 401)
			return ;
		else
...
export function handleMute(enqueueSnackbar: any, currentUser: User, user: User, currentChat: Chat) {
	...
	axios.post("http://" + "f1r3s17" + ":3000/chat/" + currentUser.id + "/mute/" + currentChat.id, data, {withCredentials: true})
	.catch((err) => {
		if (err.response.data.statusCode === 401)
			return ;
		else
...
export function handleUnmute(enqueueSnackbar: any, currentUser: User, user: User, currentChat: Chat) {
	...
	axios.post("http://" + "f1r3s17" + ":3000/chat/" + currentUser.id + "/unmute/" + currentChat.id, data, {withCredentials: true})
	.catch((err) => {
		if (err.response.data.statusCode === 401)
			return ;
		else
...
export function handleKick(enqueueSnackbar: any, currentUser: User, user: User, currentChat: Chat) {
	...
	axios.post("http://" + "f1r3s17" + ":3000/chat/" + currentUser.id + "/kick/" + currentChat.id, data, {withCredentials: true})
	.catch((err) => {
		if (err.response.data.statusCode === 401)
			return ;
		else
...
export function handleBan(enqueueSnackbar: any, currentUser: User, user: User, currentChat: Chat, time_in_seconds: number) {
	...
	axios.post("http://" + "f1r3s17" + ":3000/chat/" + user.id + "/ban/" + currentChat.id, data, {withCredentials: true})
	.catch((err) => {
		if (err.response.data.statusCode === 401)
			return ;
		else
...
export function handlePromote(enqueueSnackbar: any, currentUser: User, user: User, currentChat: Chat) {
	...
	// ban/:chatID/:userID
	axios.post("http://" + "f1r3s17" + ":3000/chat/" + currentUser.id + "/promote/" + currentChat.id, data, {withCredentials: true})
	.catch((err) => {
		if (err.response.data.statusCode === 401)
			return ;
		else
...
export function handleDemote(enqueueSnackbar: any, currentUser: User, user: User, currentChat: Chat) {
	...
	axios.post("http://" + "f1r3s17" + ":3000/chat/" + currentUser.id + "/demote/" + currentChat.id, data, {withCredentials: true})
	.catch((err) => {
		if (err.response.data.statusCode === 401)
			return ;
		else
...
export function handleInviteToGame(enqueueSnackbar: any, currentUser: User, currentChat: Chat) {
	...
	axios.post("http://" + "f1r3s17" + ":3000/chat/" + currentUser.id + "/game-invite/" + currentChat.id, { }, {withCredentials: true})
	.catch((err) => {
		if (err.response.data.statusCode === 401)
			return ;
		else
